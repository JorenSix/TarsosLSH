...
When everything runs correctly you should be able to run comamnd line applications and have the latest version of the TarsosLSH library for inclusion in your projects. Also the Javadoc documentation for the API should be available in TarsosLSH/doc. Drop me a line if you use TarsosLSH in your project. Always nice to hear how this software is used.

The fastest way to get something on your screen is executing this on your command line: @java - jar TarsosLSH.jar@ this lets LSH run on a random data set. The full reference of the command line example is included below:
